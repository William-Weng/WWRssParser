...
- [A lightweight, pure Swift RSS 2.0 / Atom 1.0 parser designed specifically for iOS development.](https://validator.w3.org/feed/docs/rss2.html)
- [是一個輕量級、純 Swift 寫的 RSS 2.0 / Atom 1.0 解析器，專為 iOS 開發設計。](https://blog.gslin.org/archives/2022/07/02/10772/自己刻-rss-2-0-的簡單方式/)
...
```bash
dependencies: [
    .package(url: "https://github.com/William-Weng/WWRssParser.git", .upToNextMajor(from: "1.0.3"))
]
```
